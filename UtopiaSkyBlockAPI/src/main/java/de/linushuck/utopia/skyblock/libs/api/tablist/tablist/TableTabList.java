...
import de.linushuck.utopia.skyblock.libs.api.tablist.item.BlankTabItem;
 ...
 * is the top right.
 * <p>
 * It supports some fancy operations like filling up a portion of the table
 * in any direction.
 */
@Getter
@ToString
public class TableTabList extends SimpleTabList
{
    ...
    {
        return fill(box.getTopLeft().getColumn(), box.getTopLeft().getRow(), box.getBottomRight()
                .getColumn(), box.getBottomRight().getRow(), items, startCorner, direction);
    }
